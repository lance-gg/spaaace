...
var updateLeaderboard = function updateLeaderboard(req, res) {
  ...
  if (!req.body) return;
  var leaderboardArray = req.body.rows.split(","); // Create the object from raw data
...
var createLeaderboard = function createLeaderboard(leaderboardObject) {
  var accuracyLeaderboard = Object.keys(leaderboardObject).sort(function (a, b) {
    ...
    return _objectSpread({}, leaderboardObject[element], {
      department: element
    });
  });
...
var prepareAssetText = function prepareAssetText(boardString, boardObj, newItem, index) // addedNewAssetCallback
{
