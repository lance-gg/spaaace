  ...
  _createClass(SpaaaceServerEngine, [{
    ...
    value: function start() {
      ...
      this.gameEngine.on("missileHit", function (e) {
        ...
        if (_this2.scoreData[roomName][e.missile.ownerId]) _this2.scoreData[roomName][e.missile.ownerId].kills++;
    ...
    value: function onPlayerDisconnected(socketId, playerId) {
      var _this4 = this;
      _get(_getPrototypeOf(SpaaaceServerEngine.prototype), "onPlayerDisconnected", this).call(this, socketId, playerId);
